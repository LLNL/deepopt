...
for i in range(n_iterations):
    ...
    candidates_file = f"suggested_inputs_iter{i+1}.npy" # save new proposed inputs to evaluate
    ckpt_file = f"learner_{model_type}_iter{i+1}.ckpt" # save model for this iteration
