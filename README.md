...
```
cd existing_repo
git remote add origin https://lc.llnl.gov/gitlab/kur1/deepopt_release.git
git branch -M main
...
- [ ] [Set up project integrations](https://lc.llnl.gov/gitlab/kur1/deepopt_release/-/settings/integrations)
